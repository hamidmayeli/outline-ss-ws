...
public interface IClientRepository
{
    ...
    Task<Client> CreateAsync(string name, long? limit, DateTime? expiresOn);
    Task<Client> CreateAsync(string name, long? limit, bool isSingleConnection, DateTime? expiresOn);
